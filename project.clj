(defproject workable-reagent "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "workable-reagent.jar"
  :main workable-reagent.server
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             :figwheel {:on-jsload "workable-reagent.core/mount-root"}
             :compiler
             {:main "workable-reagent.dev"
              :asset-path "/js/out"
              :output-to "target/cljsbuild/public/js/app.js"
  ...
  :profiles {:dev {:repl-options {:init-ns workable-reagent.repl}
